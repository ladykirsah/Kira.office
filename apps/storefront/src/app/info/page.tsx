    ...
    <div style={{ maxWidth: 720, margin: "0 auto" }}>
      ...
      <div className="card" style={{ padding: "8px 24px 24px" }}>
        ...
        <Section title="การเปลี่ยน/คืนสินค้า">
          <p style={{ margin: 0 }}>
            หากสินค้ามีปัญหา ไม่ตรงรุ่น หรือได้รับสินค้าผิด สามารถกดยกเลิก/เคลมในคำสั่งซื้อได้ภายใน
            7 วัน นับจากคำสั่งซื้อมีสถานะสำเร็จ จากนั้นทีมช่างจะติดต่อกลับทาง LINE
            เพื่อขอรูปถ่ายสินค้า รายละเอียดทั้งหมดดูได้ที่{" "}
