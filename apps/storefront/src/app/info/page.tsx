    ...
    <div style={{ maxWidth: 720, margin: "0 auto" }}>
      ...
      <div className="card" style={{ padding: "8px 24px 24px" }}>
        ...
        <Section title="การเปลี่ยน/คืนสินค้า">
          <p style={{ margin: 0 }}>
            หากสินค้ามีปัญหา ไม่ตรงรุ่น หรือได้รับสินค้าผิด สามารถกดยกเลิก/เคลมในคำสั่งซื้อ
            พร้อมแนบรูปถ่ายสินค้าได้ ระยะเวลาการคืน/เคลมแตกต่างกันตามประเภทสินค้า
            (ระบุไว้ในหน้ารายละเอียดสินค้าแต่ละชิ้น) รายละเอียดทั้งหมดดูได้ที่{" "}
            <a href="/returns" style={{ color: "var(--brand-blue)", textDecoration: "underline" }}>
              นโยบายการเคลม คืนสินค้า และรับประกัน
            </a>
          </p>
        </Section>
      </div>
