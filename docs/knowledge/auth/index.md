...
- [emergency-key](emergency-key.md) — the owner's second way back in: a self-set secret key, beside the emailed Access code. Four-character floor, its own throttle, super admin alone, no readable copy.
